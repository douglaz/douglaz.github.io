...
The same passage names the banking-channel power explicitly: a bank of issue's interest-rate setting *is* the credit policy, and the demand for its credit fluctuates only with that policy. The lever is real, internal, and asymmetric — it can suppress the rate below the natural level on demand.
...
**4. The boom must end.** Time preferences are unchanged. Real savings are unchanged. The capital structure now in motion cannot be completed with the resources actually available. Either the bank keeps issuing fresh fiduciary media to extend the artificial rate (postponing the reckoning at the cost of a larger eventual correction — and, in the limit, a crack-up boom that destroys the currency), or it stops and the natural rate reasserts itself, at which point the longest-duration projects are revealed as unprofitable. They are liquidated. That liquidation is the bust.

**5. 100% reserves removes step 1, which removes the rest.** Under 100% reserves, banks cannot offer credit *in addition to* what their customers have saved. Lending is restricted to time-deposit funds — what Mises calls *commodity-credit* and distinguishes from circulation-credit in [[credit-and-deferred-payment|Credit and Deferred Payment]]. Commodity-credit reflects an actual transfer of present-good claims from savers to borrowers; the loan rate adjusts to clear the market between the actual savers and the actual borrowers, and the resulting rate *is* the natural rate. There is no wedge between the loan rate and the time-preference rate to drive entrepreneurial miscalculation, no false signal to lengthen the capital structure beyond what voluntary savings can sustain, no boom built on resources that do not exist, and therefore no bust required to correct it.
