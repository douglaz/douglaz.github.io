...
> there can be no theoretical determination of purchasing power which could do without the notions of cash holding and demand for and supply of money.
>
...
- **Money proper** — commodity money (specie).
- **Money-certificates** — money-substitutes fully covered by reserves; pure warehouse receipts.
- **Fiduciary media** — money-substitutes *not* covered by reserves.
- **Money in the broader sense** = money proper + money-substitutes (both certificates and fiduciary media).

The demand for money is the aggregate demand for the *broader* category — people are willing to hold bank notes or deposits in place of coin if they accept them as money. This is what makes a fractional-reserve banking system's expansion of fiduciary media inflation-relevant: each new uncovered claim adds to broader-sense supply and only generates upward pressure on purchasing power if broader-sense demand happens to absorb it.

## Why this primitive matters editorially

A wiki built around the Austrian-libertarian frame cannot reason about CPI debates, QE episodes, balance-sheet policy, capital controls, or currency crises without naming the demand side. Every news item that says "the central bank added X billion to the monetary base, so prices will rise by Y" is making a one-sided argument the Austrian framework rejects on its face. The right framing is always: *what happened to the money relation* — both sides — and what does that tell us about likely effects on the objective exchange-value of money.
